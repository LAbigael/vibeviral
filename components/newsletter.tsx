        ...
        <div className="pb-12 md:pb-20">
          ...
          >
            ...
            <div
              ...
              aria-hidden="true"
            >
              <svg className="text-accent-200" width="428" height="328" xmlns="http://www.w3.org/2000/svg">
                <defs>
                  <radialGradient
                    cx="35.542%"
                    cy="34.553%"
                ...
                <g fill="none" fillRule="evenodd">
                  <g className="fill-accent-200" fill="#FFF">
                    <ellipse
                      fillOpacity=".04"
                      cx="185"
                      cy="15.576"
                  ...
                  <circle className="fill-"  fill="url(#ni-a)" cx="276" cy="237" r="200" />
                </g>
              </svg>
            </div>
